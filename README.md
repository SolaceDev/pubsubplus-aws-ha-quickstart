...
| Public Subnet IDs (PublicSubnetIDs) | _Requires_ _input_ | Provide public subnet IDs in your existing VPC (e.g., subnet-4b8d329f,subnet-bd73afc8,subnet-a01106c2), matching your deployment architecture. Note: leave it empty or it will be ignored if you set the Use private subnets parameter to *false*. |
| Private Subnet IDs (PrivateSubnetIDs) | _Requires_ _input_ | Provide private subnet IDs in your existing VPC (e.g., subnet-4b8d329f,subnet-bd73afc8,subnet-a01106c2), matching your deployment architecture. Note: leave it empty or it will be ignored if you set the Use private subnets parameter to *true*. |
